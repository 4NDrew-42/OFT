...
export const FABRIC_BASE_URL = process.env.NEXT_PUBLIC_ORION_API_URL || 'http://localhost:8089';
// Back-compat alias (some hooks import ORION_VECTOR_URL)
export const ORION_VECTOR_URL = FABRIC_BASE_URL;
export const CHAT_STREAM_URL = process.env.NEXT_PUBLIC_CHAT_STREAM_URL || 'http://192.168.50.79:3002/api/chat-enhanced';
